...
{
	public class GenericReposistory<TEntity, Tkey> : IGenericRepository<TEntity, Tkey> where TEntity : BaseEntites<Tkey>
	{
		private readonly StoreDbContext _context;
		
		public GenericReposistory(StoreDbContext context) => _context = context;
		...
		public async void AddAsync(TEntity entity)=> await _context.AddAsync(entity);
